...
test("compiles a platform-neutral hook plan", () => {
  ...
  assert.equal(plan.planHash, "0x90fbbc8d4ea9febf24ecb19cdc7ff0d2fc630b70d1f72334ec2375cb79995e8f");
...
test("validates HookPlan artifacts at the public boundary", () => {
  const plan = compileZhixuHookPlan(baseZhixu);
